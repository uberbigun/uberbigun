...
#
# Version 2 of get-otx-iocs.py
#
# 11-22-2017 - Scott Carpenter uberbigun@gmail.com
#
...
# Towards that end, the C2 indicators have been seperated into three files rather than one.
...
class OTXReceiver():
    ...
    def __init__(self, api_key, siem_mode, debug, proxy):
        ...
        if siem_mode:
            self.separator = ","
            self.use_csv_header = False # McAfee can only take raw values
            self.extension = "txt"
    ...
    def write_iocs(self, ioc_folder):
        ...
        c2_ioc_domain_file = os.path.join(ioc_folder, "otx-c2-iocs-domain.{0}".format(self.extension))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='OTX IOC Receiver v2')
